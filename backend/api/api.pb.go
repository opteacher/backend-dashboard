...
type ApiInfo struct {
	...
	//	*ApiInfo_Timing
	//	*ApiInfo_Subscribe
	Activated            isApiInfo_Activated `protobuf_oneof:"activated"`
...
type isApiInfo_Activated interface {
	isApiInfo_Activated()
	MarshalTo([]byte) (int, error)
	Size() int
}

type ApiInfo_Http struct {
	Http *ActivatedByHttp `protobuf:"bytes,8,opt,name=http,proto3,oneof"`
}
type ApiInfo_Timing struct {
	Timing *ActivatedByTiming `protobuf:"bytes,9,opt,name=timing,proto3,oneof"`
}
type ApiInfo_Subscribe struct {
	Subscribe *ActivatedBySubscribe `protobuf:"bytes,10,opt,name=subscribe,proto3,oneof"`
}

func (*ApiInfo_Http) isApiInfo_Activated()      {}
func (*ApiInfo_Timing) isApiInfo_Activated()    {}
func (*ApiInfo_Subscribe) isApiInfo_Activated() {}

func (m *ApiInfo) GetActivated() isApiInfo_Activated {
	if m != nil {
		return m.Activated
	}
	return nil
...
func (m *ApiInfo) GetHttp() *ActivatedByHttp {
	if x, ok := m.GetActivated().(*ApiInfo_Http); ok {
		return x.Http
	}
	return nil
}

func (m *ApiInfo) GetTiming() *ActivatedByTiming {
	if x, ok := m.GetActivated().(*ApiInfo_Timing); ok {
		return x.Timing
	}
	return nil
}

func (m *ApiInfo) GetSubscribe() *ActivatedBySubscribe {
	if x, ok := m.GetActivated().(*ApiInfo_Subscribe); ok {
		return x.Subscribe
	}
	return nil
}
...
func (*ApiInfo) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ApiInfo_OneofMarshaler, _ApiInfo_OneofUnmarshaler, _ApiInfo_OneofSizer, []interface{}{
		(*ApiInfo_Http)(nil),
		(*ApiInfo_Timing)(nil),
		(*ApiInfo_Subscribe)(nil),
	}
}

func _ApiInfo_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ApiInfo)
	// activated
	...
	case nil:
	default:
		return fmt.Errorf("ApiInfo.Activated has unexpected type %T", x)
	}
	return nil
}

func _ApiInfo_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ApiInfo)
	switch tag {
	case 8: // activated.http
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ActivatedByHttp)
		err := b.DecodeMessage(msg)
		m.Activated = &ApiInfo_Http{msg}
		return true, err
	case 9: // activated.timing
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ActivatedByTiming)
		err := b.DecodeMessage(msg)
		m.Activated = &ApiInfo_Timing{msg}
		return true, err
	case 10: // activated.subscribe
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ActivatedBySubscribe)
		err := b.DecodeMessage(msg)
		m.Activated = &ApiInfo_Subscribe{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ApiInfo_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ApiInfo)
	// activated
	switch x := m.Activated.(type) {
	case *ApiInfo_Http:
...
var fileDescriptor_1b40cafcd4234784 = []byte{
	...
	,
}
...
func (m *ActivatedByTiming) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Crontab) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintApi(dAtA, i, uint64(len(m.Crontab)))
		i += copy(dAtA[i:], m.Crontab)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *ApiInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Activated != nil {
		nn3, err := m.Activated.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn3
...
func (m *ApiInfo_Http) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Http != nil {
		dAtA[i] = 0x42
		i++
...
func (m *ApiInfo_Timing) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Timing != nil {
		dAtA[i] = 0x4a
		i++
...
func (m *ApiInfo_Subscribe) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Subscribe != nil {
		dAtA[i] = 0x52
		i++
...
func (m *ApiInfo_Http) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApiInfo_Timing) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApiInfo_Subscribe) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ActivatedByTiming) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Crontab", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Crontab = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApi(dAtA[iNdEx:])
...
func (m *ApiInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			v := &ActivatedBySubscribe{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Activated = &ApiInfo_Subscribe{v}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Returns", wireType)

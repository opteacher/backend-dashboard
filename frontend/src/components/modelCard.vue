...
<el-card class="box-card model-card" :style="`left: ${model.x}px; top: ${model.y}px; width: ${model.width}px; height: ${model.height}px`">
    <div slot="header" class="clearfix" v-drag="model">
    ...
    <el-link class="resize-button" type="primary" v-resize="model">
        ...
        drag: { bind(el, binding) {
            ...
            el.onmousedown = me => {
                ...
                document.onmousemove = e => {
                    ...
                    model.x = l
                    model.y = t
                    model.notifyUpdate && model.notifyUpdate()
                }
                document.onmouseup = async e => {
                    document.onmousemove = null
                    document.onmouseup = null
                    let res = await modelBkd.upd({
                        id: model.id,
